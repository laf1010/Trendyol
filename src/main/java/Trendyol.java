...
public class Trendyol {
    ...
    private static void kuponGiris(WebDriver driver) throws InterruptedException {
    ...
    private static void sepeteEkle(WebDriver driver) {
...
//            driver.findElement(className("search-box")).sendKeys(Keys.ENTER);
    ...
    private static void trendyolGiris(WebDriver driver, By aramaAlani) throws InterruptedException {
    ...
    private static void popupKapa(WebDriver driver) throws InterruptedException {
        int count=10;
        while(count>1) {
    ...
    private static void sepetSil(WebDriver driver) {
        driver.findElement(By.xpath("//a[@href='/sepetim#/basket']")).click();
